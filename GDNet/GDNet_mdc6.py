...
class Guidance(nn.Module):
    def __init__(self):
        ...
        self.weight_gd13 = nn.Conv2d(48, 2880, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gd14 = nn.Conv2d(48, 2880, (3, 3), (1, 1), (1, 1), bias=False)
    ...
    def forward(self, x):
        ...
        # gd11, gd12, gd13, gd14: 2880, H/8, W/8
        # 2880 = 48*6*10
        x = self.conv11(x)
...
class CostAggregation(nn.Module):
    def __init__(self, maxdisp=192):
        ...
        self.gd13 = GD6_Block(48, 3)
        self.gd14 = GD6_Block(48, 3)
...
class GDNet_mdc6(nn.Module):
    def __init__(self, max_disparity=192):
        super(GDNet_mdc6, self).__init__()
        self.max_disparity = max_disparity
