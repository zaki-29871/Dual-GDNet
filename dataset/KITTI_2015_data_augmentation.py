...
KITTI_data_augmentation(indexes[:int(copy_size * 0.8)], 'training', int(total_data_size * 0.8))

print('Generating testing data')
KITTI_data_augmentation(indexes[int(copy_size * 0.8):], 'testing', int(total_data_size * 0.2))